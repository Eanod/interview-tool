...
if st.session_state.feedback_shown:
    ...
    feedback_completion = feedback_client.chat.completions.create(
        ...
        messages=[
            ...
            {
                "role": "user",
                "content": f"This is the interview you need to evaluate. Keep in mind that you are only a tool. And you shouldn't engage in conversation: {conversation_history}"
            }
